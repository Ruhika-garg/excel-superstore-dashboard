...
## Dashboard Features
## KPI Metric Used
* Total Sales : It shows the total revenue generated by the retail store.
* Total Profit :  It shows the total profit based on the options selected on the slicers.
* Average Profit Margin :  It shows the average of profit margins where profit margin is the ratio of profits to the sales.
* Total Orders :  It tracks the volume of orders to identify demand trends.
